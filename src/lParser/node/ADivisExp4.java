...
public final class ADivisExp4 extends PExp4
{
    private PExp4 _exp4_;
    private TDivis _divis_;
    ...
    public ADivisExp4(
        ...
        @SuppressWarnings("hiding") TDivis _divis_,
    ...
    public Object clone()
    {
        return new ADivisExp4(
            cloneNode(this._exp4_),
            cloneNode(this._divis_),
    ...
    {
        ((Analysis) sw).caseADivisExp4(this);
    }
    ...
    public TDivis getDivis()
    {
        return this._divis_;
    }

    public void setDivis(TDivis node)
    {
        if(this._divis_ != null)
        {
            this._divis_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._divis_ == oldChild)
        {
            setDivis((TDivis) newChild);
            return;
        }
